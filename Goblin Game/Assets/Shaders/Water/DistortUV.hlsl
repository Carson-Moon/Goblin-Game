...
{
    float timeSpeedMultiplier = 3.0;
    float time = _Time.x * timeSpeedMultiplier;

    UV.y += Amount * 0.1 * (sin(UV.x * 3.5 + time * 0.35) + sin(UV.x * 4.8 + time * 1.05) + sin(UV.x * 7.3 + time * 0.45)) / 3.0;
